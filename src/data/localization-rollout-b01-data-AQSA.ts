...
export const profiles: Record<RolloutLanguage, LanguageProfile> = {
  ...
  ru: { generator: 'Генератор', converter: 'Конвертер', formatter: 'Форматировщик', free: 'бесплатно', slugPrefix: 'generator', joiner: '', intro: 'Создавайте понятные черновики на русском и проверяйте результат перед использованием.', intent: 'Локальный запрос соответствует английской странице инструмента.', review: 'Проверяйте точность, оригинальность, совместимость и правила проекта перед публикацией.', faqTopics: ['полезные идеи', 'скопировать результат', 'проверить перед использованием'] },
  tr: { generator: 'Oluşturucu', converter: 'Dönüştürücü', formatter: 'Biçimlendirici', free: 'ücretsiz', slugPrefix: 'olusturucu', joiner: '', intro: 'Türkçe net taslaklar oluşturun ve kullanmadan önce sonucu kontrol edin.', intent: 'Yerel arama niyeti İngilizce araçla aynı amaca hizmet eder.', review: 'Yayınlamadan önce doğruluk, özgünlük, uyumluluk ve proje kurallarını kontrol edin.', faqTopics: ['yararlı fikirler', 'sonucu kopyalama', 'kullanmadan önce kontrol'] },
  ...
  sv: { generator: 'Generator för', converter: 'Konverterare för', formatter: 'Formatterare för', free: 'gratis', slugPrefix: 'generator', joiner: 'för', intro: 'Skapa tydliga utkast på svenska och granska resultatet innan du använder det.', intent: 'Lokal sökintention matchar det engelska verktygets syfte.', review: 'Kontrollera noggrannhet, originalitet, kompatibilitet och projektregler före publicering.', faqTopics: ['användbara idéer', 'kopiera resultat', 'granska före användning'] },
  ...
  bg: { generator: 'Генератор за', converter: 'Конвертор за', formatter: 'Форматиращ инструмент за', free: 'безплатно', slugPrefix: 'generator', joiner: 'за', intro: 'Създавайте ясни чернови на български и проверявайте резултата преди употреба.', intent: 'Локалното търсене съвпада с намерението на английския инструмент.', review: 'Проверявайте точността, оригиналността, съвместимостта и правилата на проекта преди публикуване.', faqTopics: ['полезни идеи', 'копиране на резултат', 'проверка преди употреба'] },
...
const tools: RolloutToolSpec[] = [
  ...
  { canonicalToolId: 'random-number-generator', label: 'Números Aleatorios', slugBase: 'numeros-aleatorios', kind: 'utility' },
  ...
  { canonicalToolId: 'color-palette-generator', label: 'Paletas de Colores', slugBase: 'paletas-de-colores', kind: 'developer' },
