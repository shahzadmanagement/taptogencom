...
export const localizedPilotToolData: LocalizedToolContent[] = [
  ...
  },
  {
    ...
    "h1": "Générateur de pseudo",
    "metaTitle": "Générateur de pseudo gratuit",
  ...
  },
  {
    ...
    "metaTitle": "Générateur de nom d'entreprise gratuit",
    "metaDescription": "Trouvez des idées de noms pour une entreprise, une activite ou un service professionnel.",
    "intro": "Générez des pistes de noms puis vérifiez marque, domaine et contexte sectoriel.",
    "faqTopics": [
      "nom d'entreprise",
  ...
  },
  {
    ...
    "h1": "Générateur de noms fantasy",
    "metaTitle": "Générateur de noms fantasy gratuit",
    "metaDescription": "Creez des noms fantasy pour romans, jeux de role et univers imaginaires.",
    "intro": "Générez des pistes originales pour personnages, lieux ou peuples fictifs sans copier d'univers protege.",
    "faqTopics": [
      "noms fantasy",
      "noms jeu de role",
      "noms de mondes"
  ...
  },
  {
    ...
    "h1": "Générateur de noms de personnages",
    "metaTitle": "Générateur de noms de personnages gratuit",
  ...
  },
  {
    ...
    "h1": "Générateur de prenoms",
    "metaTitle": "Générateur de prenoms gratuit",
    "metaDescription": "Explorez des idées de prenoms pour bebe avec des suggestions fáciles a comparer.",
    "intro": "Générez des prenoms possibles et vérifiez sens, prononciation et usage local.",
    "faqTopics": [
      "prenoms fille",
      "prenoms garcon",
  ...
  },
  {
    ...
    "h1": "Générateur de noms de famille",
    "metaTitle": "Générateur de noms de famille gratuit",
    "metaDescription": "Creez des noms de famille fictifs pour personnages, histoires et exemples.",
    "intro": "Générez des idées de patronymes et relisez-les pour eviter les stereotypes ou confusions.",
    "faqTopics": [
  ...
  },
  {
    ...
    "h1": "Générateur de deuxieme prenom",
    "metaTitle": "Générateur de deuxieme prenom gratuit",
  ...
  },
  {
    ...
    "h1": "Générateur de noms d'equipe",
    "metaTitle": "Générateur de noms d'equipe gratuit",
    "metaDescription": "Creez des noms d'equipe pour projets, loisirs, classes ou groupes creatifs.",
    "intro": "Trouvez une idee de nom d'equipe puis vérifiez qu'elle reste claire et inclusive.",
    "faqTopics": [
      "noms d'equipe",
      "noms de groupe",
      "equipe originale"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de nom de domaine gratuit",
    "metaDescription": "Trouvez des idées de noms de domaine pour sites, produits et entreprises.",
    "intro": "Générez des pistes puis vérifiez disponibilité, extension et marque avant achat.",
    "faqTopics": [
      "idee nom de domaine",
      "domaine site web",
      "verifier domaine"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de nom de produit gratuit",
    "metaDescription": "Trouvez des idées de noms pour produits, collections, fonctionnalites ou lancements.",
    "intro": "Générez des pistes de naming produit et vérifiez clarte, marque et positionnement.",
    "faqTopics": [
      "nom de produit",
      "naming produit",
      "idee produit"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de nom de projet gratuit",
  ...
  },
  {
    ...
    "metaTitle": "Générateur de kit de marque gratuit",
    "metaDescription": "Creez une base de marque avec idées de ton, messages, couleurs et elements initiaux.",
    "intro": "Utilisez le kit comme brouillon et vérifiez coherence, droits et usage reel.",
    "faqTopics": [
      "kit de marque",
      "identite de marque",
      "branding"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de slogan gratuit",
    "metaDescription": "Trouvez des slogans courts pour marques, campagnes, produits ou projets.",
    "intro": "Creez des accroches puis vérifiez originalite, promesses et adequation au public.",
    "faqTopics": [
      "slogan publicitaire",
      "slogan marque",
  ...
  },
  {
    ...
    "h1": "Générateur de baseline",
    "metaTitle": "Générateur de baseline gratuit",
    "metaDescription": "Creez une baseline courte pour clarifier le positionnement d'une marque ou d'un produit.",
    "intro": "Générez des pistes de signature puis controlez sens, originalite et promesses.",
    "faqTopics": [
      "baseline marque",
      "signature de marque",
      "accroche courte"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de nom de blog gratuit",
    "metaDescription": "Trouvez des idées de noms pour blogs, newsletters et projets editoriaux.",
    "intro": "Creez des pistes de nom et vérifiez domaine, ton et coherence avec la niche.",
    "faqTopics": [
      "nom de blog",
      "idee blog",
      "blog personnel"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de nom de podcast gratuit",
    "metaDescription": "Trouvez des idées de noms pour podcasts, emissions audio et series d'episodes.",
    "intro": "Générez des pistes puis vérifiez annuaires, domaine et marque avant lancement.",
    "faqTopics": [
      "nom de podcast",
      "idee podcast",
      "titre podcast"
  ...
  },
  {
    ...
    "h1": "Générateur de tags video",
    "metaTitle": "Générateur de tags video gratuit",
  ...
  },
  {
    ...
    "h1": "Générateur de hashtags",
    "metaTitle": "Générateur de hashtags gratuit",
    "metaDescription": "Creez des hashtags pertinents pour publications, campagnes et idées de contenu.",
    "intro": "Générez des suggestions puis vérifiez contexte, ton et actualite avant publication.",
    "faqTopics": [
  ...
  },
  {
    ...
    "h1": "Générateur de mots cles",
    "metaTitle": "Générateur de mots cles gratuit",
    "metaDescription": "Trouvez des idées de mots cles pour contenu, SEO, annonces ou recherche initiale.",
    "intro": "Générez des pistes puis validez volume, concurrence et intention de recherche.",
    "faqTopics": [
      "mots cles SEO",
      "idées keywords",
  ...
  },
  {
    ...
    "h1": "Générateur de balises meta",
    "metaTitle": "Générateur de balises meta gratuit",
    "metaDescription": "Creez des brouillons de balises meta pour pages web, SEO et apercus sociaux.",
    "intro": "Générez une base puis controlez longueur, pertinence et integration technique.",
    "faqTopics": [
      "balises meta SEO",
      "meta title",
      "meta description"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de meta description gratuit",
    "metaDescription": "Redigez des brouillons de meta descriptions pour pages, articles et fiches produit.",
    "intro": "Générez un texte court puis ajustez longueur, precision et promesse de clic.",
    "faqTopics": [
  ...
  },
  {
    ...
    "metaTitle": "Générateur de titre SEO gratuit",
    "metaDescription": "Creez des idées de titres SEO pour pages, articles, guides et fiches produit.",
    "intro": "Générez plusieurs titres puis vérifiez longueur, intention et exactitude.",
    "faqTopics": [
      "titre SEO",
      "balise title",
      "titre Google"
  ...
  },
  {
    ...
    "metaTitle": "Générateur de FAQ gratuit",
    "metaDescription": "Creez des idées de questions frequentes pour pages, produits, services ou articles.",
    "intro": "Générez une structure de FAQ puis vérifiez les reponses et les limites du sujet.",
    "faqTopics": [
  ...
  },
  {
    ...
    "metaTitle": "Générateur de balise canonique gratuit",
    "metaDescription": "Creez une balise canonique pour signaler l'URL preferee d'une page.",
    "intro": "Générez un brouillon puis vérifiez l'URL, le protocole et l'integration HTML.",
    "faqTopics": [
      "balise canonical",
      "URL canonique",
      "SEO technique"
  ...
  },
  {
    ...
    "metaTitle": "Générateur robots.txt gratuit",
  ...
  },
  {
    ...
    "metaTitle": "Générateur Open Graph gratuit",
    "metaDescription": "Creez des balises Open Graph pour ameliorer les apercus de liens partages.",
    "intro": "Générez les champs principaux puis vérifiez titre, description, image et URL.",
    "faqTopics": [
      "Open Graph",
      "balises sociales",
      "apercu lien"
  ...
  },
  {
    ...
    "h1": "Générateur de texte stylise",
    "metaTitle": "Générateur de texte stylise gratuit",
    "metaDescription": "Transformez du texte en styles decoratifs a copier pour profils et messages.",
    "intro": "Générez du texte stylise puis vérifiez lisibilite et compatibilite selon la plateforme.",
    "faqTopics": [
      "texte stylise",
      "police a copier",
      "lettres decoratives"
  ...
  },
  {
    ...
    "intro": "Générez une version cursive puis controlez lisibilite et compatibilite.",
    "faqTopics": [
      "ecriture cursive",
      "cursif a copier",
      "lettres manuscrites"
  ...
  },
  {
    ...
    "h1": "Générateur de texte italique",
    ...
    "intro": "Générez une version italique puis vérifiez affichage et lisibilite.",
    "faqTopics": [
      "italique unicode",
      "texte penche",
      "italique a copier"
  ...
  },
  {
    ...
    "intro": "Utilisez le petit texte avec moderation et vérifiez lisibilite sur mobile.",
    "faqTopics": [
      "petites lettres",
      "small text",
      "texte miniature"
  ...
  },
  {
    ...
    "h1": "Générateur de paragraphes",
    "metaTitle": "Générateur de paragraphes gratuit",
    "metaDescription": "Creez des brouillons de paragraphes pour idées, articles, descriptions ou exercices.",
    "intro": "Générez une base de texte puis relisez faits, ton et originalite.",
    "faqTopics": [
  ...
  },
  {
    ...
    "h1": "Générateur de phrases",
    "metaTitle": "Générateur de phrases gratuit",
    "metaDescription": "Creez des phrases d'exemple pour ecriture, apprentissage, contenu ou ideation.",
    "intro": "Générez des phrases puis adaptez grammaire, contexte et precision.",
    "faqTopics": [
      "phrases exemple",
      "creer une phrase",
      "idées de phrases"
  ...
  },
  {
    ...
    "h1": "Générateur d'idées d'ecriture",
    ...
    "intro": "Générez un point de depart puis adaptez-le a votre voix et a votre genre.",
    "faqTopics": [
      "prompts ecriture",
      "idées histoire",
      "exercice ecriture"
  ...
  },
  {
    ...
    "h1": "Générateur de plan d'article",
    "metaTitle": "Générateur de plan d'article gratuit",
    "metaDescription": "Creez un plan d'article avec sections, sous-titres et idées principales.",
    "intro": "Générez une structure puis adaptez-la a l'intention de recherche et a votre expertise.",
    "faqTopics": [
      "plan article blog",
      "structure article",
      "outline blog"
  ...
  },
  {
    ...
    "h1": "Générateur de description produit",
    "metaTitle": "Générateur de description produit gratuit",
    "metaDescription": "Redigez des brouillons de descriptions pour produits, boutiques et fiches e-commerce.",
    "intro": "Générez une base puis vérifiez faits, avantages, politiques et conformite.",
    "faqTopics": [
      "description produit",
      "fiche produit",
      "texte ecommerce"
