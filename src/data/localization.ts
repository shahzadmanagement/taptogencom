...
const legacySpanishPilotTools: LocalizedToolContent[] = [
  ...
  { canonicalToolId: 'middle-name-generator', primaryKeyword: 'generador de segundo nombre', localizedSlug: 'generador-de-segundo-nombre', h1: 'Generador de segundo nombre', metaTitle: 'Generador de segundo nombre gratis', metaDescription: 'Encuentra ideas de segundo nombre para combinaciones personales, personajes o listas creativas.', intro: 'Genera opciones que encajen con nombre y apellido, y revisa pronunciación y contexto.', faqTopics: ['segundo nombre ideas', 'nombres compuestos', 'combinaciones de nombres'], searchIntentNote: 'Spanish intent is narrower but aligned with middle-name selection.', riskSafetyNote: 'Sensitive personal naming; no legal promises.', language: 'es' },
  ...
  { canonicalToolId: 'seo-title-generator', primaryKeyword: 'generador de títulos SEO', localizedSlug: 'generador-de-titulos-seo', h1: 'Generador de títulos SEO', metaTitle: 'Generador de títulos SEO gratis', metaDescription: 'Crea ideas de títulos SEO para paginas, articulos, guias y fichas de producto.', intro: 'Genera opciones de título y revisa longitud, intención y exactitud antes de usarlas.', faqTopics: ['titulo SEO', 'title tag', 'titulos para Google'], searchIntentNote: 'Direct SEO title intent.', riskSafetyNote: 'No ranking guarantees; avoid misleading clickbait.', language: 'es' },
