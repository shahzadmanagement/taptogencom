...
const batch7CustomGuides: Record<string, { howTo: string[]; tips: { title: string; body: string }[] }> = {
  "fantasy-language-generator": {
    ...
    "tips": [
      {
        "title": "Define phonetic roots",
        "body": "Consistent vowel sounds give your fantasy language a cohesive aesthetic identity."
      },
      {
        "title": "Avoid real-world trademarks",
        "body": "Ensure generated dialect words do not inadvertently mirror protected fantasy franchises."
      }
    ]
  },
  "fantasy-name-generator": {
    ...
    "tips": [
      {
        "title": "Check setting tone",
        "body": "Match name harshness or elegance with your world's cultural history."
      },
      {
        "title": "Verify uniqueness",
        "body": "Confirm generated names are distinct from major published fantasy characters."
      }
    ]
  },
  "farm-name-generator": {
    ...
    "tips": [
      {
        "title": "Highlight farm heritage",
        "body": "Incorporate local landmarks or crop specializations for memorable farm branding."
      },
      {
        "title": "Ensure legibility",
        "body": "Choose farm names that look clean on signage, packaging, and digital storefronts."
      }
    ]
  },
  "glitch-text-generator": {
    ...
    "tips": [
      {
        "title": "Balance readability",
        "body": "Extreme corruption levels can make important text unreadable on mobile screens."
      },
      {
        "title": "Test destination platform",
        "body": "Some web platforms filter excessive combining Unicode marks."
      }
    ]
  },
  "ipa-generator": {
    ...
    "tips": [
      {
        "title": "Verify stress marks",
        "body": "Check primary stress symbol Placement for multi-syllable word accuracy."
      },
      {
        "title": "Account for dialect variations",
        "body": "Regional accents alter vowel symbol representation in standard IPA."
      }
    ]
  },
  "italic-text-generator": {
    ...
    "tips": [
      {
        "title": "Use for emphasis",
        "body": "Apply italics selectively to highlight key callouts and titles."
      },
      {
        "title": "Accessibility check",
        "body": "Screen readers may handle mathematical Unicode symbols differently than standard text."
      }
    ]
  },
  "last-name-generator": {
    ...
    "tips": [
      {
        "title": "Pair rhythmically",
        "body": "Combine short first names with longer surnames for natural syllable cadence."
      },
      {
        "title": "Respect cultural context",
        "body": "Verify historical accuracy when assigning regional surnames to period fiction."
      }
    ]
  },
  "lorem-ipsum-generator": {
    ...
    "tips": [
      {
        "title": "Match design density",
        "body": "Generate paragraph lengths matching target typography layout blocks."
      },
      {
        "title": "Replace before launch",
        "body": "Ensure all placeholder text is removed prior to production deployment."
      }
    ]
  },
  "meta-tag-generator": {
    ...
    "tips": [
      {
        "title": "Keep titles under 60 chars",
        "body": "Prevent SERP truncation by keeping page title tags concise."
      },
      {
        "title": "Include primary keyword",
        "body": "Place core target keywords near the beginning of meta titles and descriptions."
      }
    ]
  },
    ...
    "tips": [
      {
        ...
        "body": "Clearly delineate assigned tasks and due dates for team accountability."
      },
      {
        "title": "Keep summaries concise",
        "body": "Use bullet points to highlight key decisions over verbatim transcripts."
      }
    ]
  },
  "name-generator": {
    ...
    "tips": [
      {
        "title": "Test out loud",
        "body": "Pronounce generated names aloud to evaluate verbal clarity and recall."
      },
      {
        "title": "Verify availability",
        "body": "Always check domain and social handle registration before finalizing a name."
      }
    ]
  },
  "name-pronunciation-generator": {
    ...
    "tips": [
      {
        "title": "Capitalize stressed syllables",
        "body": "Use uppercase letters for stressed syllables (e.g. mah-REE-ah) for quick reading."
      },
      {
        "title": "Keep audio spellings simple",
        "body": "Use familiar letter combinations so readers grasp correct pronunciation instantly."
      }
    ]
  },
  "newspaper-name-generator": {
    ...
    "tips": [
      {
        "title": "Anchor with geographic terms",
        "body": "Incorporate city or region names to ground local news publication titles."
      },
      {
        "title": "Use established masthead terms",
        "body": "Words like Chronicle, Post, and Times provide instant media authority."
      }
    ]
  },
  "papyrus-generator": {
    ...
    "tips": [
      {
        "title": "Use for themed designs",
        "body": "Papyrus text styles fit historical, fantasy, or archaeological event themes."
      },
      {
        "title": "Maintain high contrast",
        "body": "Ensure background textures don't impede text legibility."
      }
    ]
  },
  "pet-tag-generator": {
    ...
    "tips": [
      {
        "title": "Prioritize phone numbers",
        "body": "Make contact phone numbers large and legible on engraving proofs."
      },
      {
        "title": "Include reward note",
        "body": "Adding 'REWARD IF FOUND' increases rapid return probability for lost pets."
      }
    ]
  },
    ...
    "tips": [
      {
        ...
        "body": "Remove duplicate entries prior to selection to ensure fair odds."
      },
      {
        "title": "Record selections",
        "body": "Screenshot or copy selected winner lists for transparent contest verification."
      }
    ]
  },
  "price-tag-generator": {
    ...
    "tips": [
      {
        "title": "Emphasize price clearly",
        "body": "Ensure final sale prices are bolded and larger than product SKUs."
      },
      {
        "title": "Include currency symbol",
        "body": "Display unambiguous currency symbols ($ / € / £) to avoid customer confusion."
      }
    ]
  },
  "product-tag-generator": {
    ...
    "tips": [
      {
        "title": "Include care icons",
        "body": "Use clear washing and care symbols alongside text instructions."
      },
      {
        "title": "Highlight key features",
        "body": "Add short 3-word value callouts like '100% Organic Cotton'."
      }
    ]
  },
  "random-number-generator": {
    ...
    "tips": [
      {
        "title": "Enable unique mode",
        "body": "Turn on non-repeating mode when drawing raffle tickets or lottery picks."
      },
      {
        "title": "Sort results",
        "body": "Sort numeric output ascendingly for easier tracking in data spreadsheets."
      }
    ]
  },
  "reverse-text-generator": {
    ...
    "tips": [
      {
        "title": "Check palindrome patterns",
        "body": "Use character reversal to quickly verify palindrome words and sentences."
      },
      {
        "title": "Preserve line breaks",
        "body": "Keep line break option enabled when reversing multi-line poetry or code."
      }
    ]
  },
  "robots-txt-generator": {
    ...
    "tips": [
      {
        "title": "Do not block CSS/JS",
        "body": "Allow crawlers access to asset files so Google can render pages properly."
      },
      {
        "title": "Test before deploying",
        "body": "Validate directives in Google Search Console URL Inspection Tool before publishing."
      }
    ]
  },
  "serif-generator": {
    ...
    "tips": [
      {
        ...
        "body": "Serif Unicode styles lend a classic, editorial feel to short social media titles."
      },
      {
        "title": "Avoid body paragraphs",
        "body": "Use standard text for body copy to ensure optimal mobile screen legibility."
      }
    ]
  },
  "small-text-generator": {
    ...
    "tips": [
      {
        "title": "Use for trademarks",
        "body": "Superscript small text is ideal for ™ and ® symbol placements."
      },
      {
        "title": "Keep it brief",
        "body": "Small caps are best suited for short 1-3 word phrases and labels."
      }
    ]
  },
  "strikethrough-text-generator": {
    ...
    "tips": [
      {
        "title": "Great for price drops",
        "body": "Cross out original prices to highlight sale prices visually in social posts."
      },
      {
        "title": "Use for completed tasks",
        "body": "Strikethrough text provides clear visual closure for completed task lists."
      }
    ]
  },
  "superhero-name-generator": {
    ...
    "tips": [
      {
        "title": "Incorporate power elements",
        "body": "Use terms matching hero capabilities (e.g. Apex, Nova, Titan, Vortex)."
      },
      {
        "title": "Check comic trademarks",
        "body": "Confirm hero names are distinct from established Marvel or DC properties."
      }
    ]
  },
  "tag-team-name-generator": {
    ...
    "tips": [
      {
        "title": "Combine member traits",
        "body": "Blend distinct wrestler traits or names to create a unified team moniker."
      },
      {
        "title": "Ensure chantability",
        "body": "Pick names with rhythmic cadence that crowd audiences can chant easily."
      }
    ]
  },
  "team-name-generator": {
    ...
    "tips": [
      {
        ...
        "body": "Choose inspiring, inclusive names that foster shared pride and identity."
      },
      {
        "title": "Keep it professional",
        "body": "Ensure corporate team names align with workplace culture standards."
      }
    ]
  },
  "text-case-converter": {
    ...
    "tips": [
      {
        "title": "Use Title Case for headlines",
        "body": "Title Case ensures consistent headline capitalization in blog posts."
      },
      {
        "title": "Use kebab-case for URLs",
        "body": "Convert title strings to lowercase hyphenated kebab-case for clean web slugs."
      }
    ]
  },
  "title-name-generator": {
    ...
    "tips": [
      {
        "title": "Include power words",
        "body": "Words like Ultimate, Essential, and Proven increase headline CTR."
      },
      {
        "title": "Match search intent",
        "body": "Ensure title promises match actual content delivered on the page."
      }
    ]
  },
    ...
    "tips": [
      {
        ...
        "body": "Most modern devices render standard Unicode symbols seamlessly."
      },
      {
        "title": "Use for key callouts",
        "body": "Apply fancy Unicode styles to short titles rather than full body text."
      }
    ]
  },
  "vaporwave-text-generator": {
    ...
    "tips": [
      {
        "title": "Perfect for retro synthwave",
        "body": "Wide-spaced text complements 80s aesthetic graphics and music titles."
      },
      {
        "title": "Use all caps for impact",
        "body": "UPPERCASE full-width characters create the strongest vaporwave aesthetic."
      }
    ]
  },
  "villain-name-generator": {
    ...
    "tips": [
      {
        "title": "Use harsh consonants",
        "body": "Sounds like K, Z, V, and X evoke natural villainous presence."
      },
      {
        "title": "Add descriptive titles",
        "body": "Combine names with titles (e.g. 'Malakor the Undying') for gravitas."
      }
    ]
  },
  "warrior-name-generator": {
    ...
    "tips": [
      {
        "title": "Reflect combat specialty",
        "body": "Incorporate weapons or battle honors (e.g. Ironclad, Shieldbreaker)."
      },
      {
        "title": "Match historical era",
        "body": "Align warrior naming conventions with the historical or fantasy setting."
      }
    ]
  },
  "word-counter": {
    ...
    "tips": [
      {
        ...
        "body": "Average reading speed is 200-250 words per minute for timing articles."
      },
      {
        "title": "Optimize metadata length",
        "body": "Keep meta descriptions between 120-160 characters for SERP display."
      }
    ]
  }
};
...
export function getEffectiveGuideCopy(tool: Tool): { howTo: string[]; tips: { title: string; body: string }[] } | null {
  return premiumGuideCopy[tool.slug] ?? batch7CustomGuides[tool.slug] ?? (batch7GuideSlugs.has(tool.slug) ? batch7GuideCopyFor(tool) : null);
}
