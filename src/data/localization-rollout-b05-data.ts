...
const tools: RolloutToolSpec[] = [
  { canonicalToolId: 'character-backstory-generator', label: 'Character Backstory', slugBase: 'character-backstory', kind: 'creative' },
  { canonicalToolId: 'worldbuilding-generator', label: 'Worldbuilding', slugBase: 'worldbuilding', kind: 'creative' },
  { canonicalToolId: 'quiz-generator', label: 'Quiz Question', slugBase: 'quiz-question', kind: 'writing' },
  { canonicalToolId: 'thesis-statement-generator', label: 'Thesis Statement', slugBase: 'thesis-statement', kind: 'writing' },
  { canonicalToolId: 'landing-page-copy-generator', label: 'Landing Page Copy', slugBase: 'landing-page-copy', kind: 'business' },
  ...
  { canonicalToolId: 'random-id-generator', label: 'Random ID', slugBase: 'random-id', kind: 'developer' },
  ...
  { canonicalToolId: 'research-question-generator', label: 'Research Question', slugBase: 'research-question', kind: 'writing' },
  ...
  { canonicalToolId: 'multiple-choice-generator', label: 'Multiple Choice Question', slugBase: 'multiple-choice-question', kind: 'writing' },
  { canonicalToolId: 'product-bullet-points-generator', label: 'Product Bullet Points', slugBase: 'product-bullet-points', kind: 'business' },
  { canonicalToolId: 'customer-persona-generator', label: 'Customer Persona', slugBase: 'customer-persona', kind: 'business' },
  { canonicalToolId: 'sales-email-generator', label: 'Sales Email', slugBase: 'sales-email', kind: 'business' },
  { canonicalToolId: 'follow-up-email-generator', label: 'Follow-Up Email', slugBase: 'follow-up-email', kind: 'business' },
  { canonicalToolId: 'image-alt-text-generator', label: 'Image Alt Text', slugBase: 'image-alt-text', kind: 'seo' },
  { canonicalToolId: 'video-prompt-generator', label: 'Video Prompt', slugBase: 'video-prompt', kind: 'creative' },
  { canonicalToolId: 'productivity-prompt-generator', label: 'Productivity Prompt', slugBase: 'productivity-prompt', kind: 'writing' },
  { canonicalToolId: 'random-list-generator', label: 'Random List', slugBase: 'random-list', kind: 'random' },
  { canonicalToolId: 'random-color-generator', label: 'Random Color', slugBase: 'random-color', kind: 'random' },
  { canonicalToolId: 'dnd-character-generator', label: 'Tabletop RPG Character', slugBase: 'tabletop-rpg-character', kind: 'gaming' },
  ...
  { canonicalToolId: 'product-benefits-generator', label: 'Product Benefits', slugBase: 'product-benefits', kind: 'business' },
