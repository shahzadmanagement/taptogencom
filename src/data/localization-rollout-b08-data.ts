...
const tools: RolloutToolSpec[] = [
  ...
  { canonicalToolId: 'letterhead-generator', label: 'Letterhead', slugBase: 'letterhead', kind: 'business' },
  ...
  { canonicalToolId: 'roman-inspired-character-name-generator', label: 'Roman Inspired Character Name', slugBase: 'roman-inspired-character-name', kind: 'creative' },
  ...
  { canonicalToolId: 'poster-generator', label: 'Poster', slugBase: 'poster', kind: 'business' },
...
const b08SafetyAddendum: Record<RolloutLanguage, Record<'business' | 'utility' | 'name' | 'fictional' | 'text' | 'seo' | 'developer', string>> = {
  ...
  it: {
    ...
    name: 'Controlla contesto, sensibilita, diritti e disponibilita prima delluso pubblico.',
  ...
  pl: {
    business: 'Sprawdz marke, zgody, ceny, dane i zgodnosc przed publicznym uzyciem.',
    utility: 'Traktuj jako praktyczna pomoc i sprawdz wynik przed waznymi decyzjami.',
    name: 'Sprawdz kontekst, wrazliwosc, prawa i dostepnosc przed publicznym uzyciem.',
    ...
    developer: 'Testuj kod i sprawdz bezpieczenstwo, dostepnosc oraz zgodnosc przed produkcja.',
  },
  ru: {
