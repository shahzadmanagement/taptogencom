...
const tools: RolloutToolSpec[] = [
  ...
  { canonicalToolId: 'text-summary-generator', label: 'Resumen de Textos', slugBase: 'resumen-de-textos', kind: 'writing' },
  ...
  { canonicalToolId: 'social-media-post-generator', label: 'Publicaciones para Redes Social', slugBase: 'publicaciones-redes-sociales', kind: 'social' },
  ...
  { canonicalToolId: 'random-word-generator', label: 'Palabras Aleatorias', slugBase: 'palabras-aleatorias', kind: 'random' },
  ...
  { canonicalToolId: 'random-height-generator', label: 'Estatura Aleatoria', slugBase: 'estatura-aleatoria', kind: 'random' },
  { canonicalToolId: 'essay-title-generator', label: 'Títulos de Ensayos', slugBase: 'titulos-de-ensayos', kind: 'writing' },
  { canonicalToolId: 'stable-diffusion-prompt-generator', label: 'Prompts para Stable Diffusion', slugBase: 'prompts-para-stable-diffusion', kind: 'writing' },
  { canonicalToolId: 'character-prompt-generator', label: 'Prompts de Personajes', slugBase: 'prompts-de-personajes', kind: 'creative' },
  { canonicalToolId: 'content-brief-generator', label: 'Briefs de Contenido', slugBase: 'briefs-de-contenido', kind: 'writing' },
  { canonicalToolId: 'press-release-generator', label: 'Notas de Prensa', slugBase: 'notas-de-prensa', kind: 'business' },
  { canonicalToolId: 'author-bio-generator', label: 'Biografía de Autor', slugBase: 'biografia-de-autor', kind: 'bio' },
  { canonicalToolId: 'viral-hook-generator', label: 'Ganchos Virales', slugBase: 'ganchos-virales', kind: 'social' },
  { canonicalToolId: 'content-calendar-generator', label: 'Calendario de Contenidos', slugBase: 'calendario-de-contenidos', kind: 'seo' },
